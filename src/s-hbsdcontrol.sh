...
#
# Code taken from /usr/share/examples/hardenedbsd/hbsdcontrol.sh of 11.2-PRERELEASE git repository state.
# Extended by @dmilith for zfs features specific to svdOS systems 2018-06-02__15-45-49.
#
