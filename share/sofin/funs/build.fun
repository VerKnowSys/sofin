        ...
        if [ "${DEF_TYPE}" = "meta" ]; then
            ...
            (
                ...
                && [ -n "${BUILD_NAMESUM}" ]; then
                    ...
                    _configure_options_log="${LOGS_DIR}$(capitalize_abs "${SOFIN_NAME}-${DEF_NAME}${DEF_SUFFIX}.config")"
                    _configuration_result="${_configure_options_log}.result"
                    _cmake_configuration_result="${LOGS_DIR}$(capitalize_abs "${SOFIN_NAME}-${DEF_NAME}${DEF_SUFFIX}.cmake.result.log")"
